...
public class newFuncts {
    private static final HashMap<String, TravelPackage> travelPackages = new HashMap<>();
    ...
    public static void editPackage() {
        ...
        if (travelPackages.containsKey(name)) {
            ...
            switch (choice) {
                ...
                case "4":
                    double newPrice = getValidPrice(myObj);
                    pkg.price = newPrice;
                ...
                case "5":
                    ...
                    double newFullPrice = getValidPrice(myObj);
